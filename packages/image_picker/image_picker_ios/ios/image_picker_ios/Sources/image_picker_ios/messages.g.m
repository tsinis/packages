    ...
    if (api) {
      NSCAssert(
          [api respondsToSelector:@selector
               (pickImageWithSource:
                            maxSize:quality:fullMetadata:overlayOpacity:overlayImage:completion:)],
          @"FLTImagePickerApi api (%@) doesn't respond to "
          @"@selector(pickImageWithSource:maxSize:quality:fullMetadata:overlayOpacity:overlayImage:"
          @"completion:)",
          api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        ...
        [api pickImageWithSource:arg_source
                  ...
                  overlayOpacity:arg_overlayOpacity
                    overlayImage:arg_overlayImage
